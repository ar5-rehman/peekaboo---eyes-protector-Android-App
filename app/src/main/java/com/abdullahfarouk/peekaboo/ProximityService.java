...
public class ProximityService extends Service {
    ...
    public void onCreate() {
        ...
        handler = new Handler();
        manager =
                (WindowManager) getApplicationContext().getApplicationContext().getSystemService(Context.WINDOW_SERVICE);
    ...
    public void showStatus(final float message) {
        Log.d("theH", "current message is: " + message+"/"+(PeekabooMain.scaleOfDistance / 2.0));
        if (message < (PeekabooMain.scaleOfDistance / 2.0)) {
